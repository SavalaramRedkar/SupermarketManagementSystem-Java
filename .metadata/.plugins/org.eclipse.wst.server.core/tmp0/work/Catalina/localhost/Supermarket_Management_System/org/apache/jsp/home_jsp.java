 ...
 * Generated at: 2021-03-15 08:26:15 UTC
...
if("exist".equals(msg))
{
      ...
      out.write("\r\n");
      out.write("\t<h3 class=\"alert alert-warning\">Product already exist in you cart! Quantity\r\n");
...
try{
	...
	while(rs.next())
	{
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td><a class=\"cart\"\r\n");
      out.write("\t\t\t\t\thref=\"addToCartAction.jsp?id=");
      out.print(rs.getString(1) );
