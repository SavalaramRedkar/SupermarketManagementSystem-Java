 ...
 * Generated at: 2021-03-05 08:57:28 UTC
...
try {
	...
	String q1 = "create table sms_users(name varchar(100),email varchar(100)primary key,mobilenumber bigint,password varchar(100),address varchar(500),city varchar(100),state varchar(100),country varchar(100))";
	String q2 = "create table sms_product(id int,name varchar(500),category varchar(200),price int,active varchar(10))";
